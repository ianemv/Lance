   ...
   <div class="full header2">
        <div class="wrap">  
			...
			<div class="social_connect">
			   ...
			   <div style="float:right; margin: 5px 50px 0 10px;border: 1px solid #666;">  
					...
					<!-- <ul class="social_icons">
						...
						<li><?php echo $html->link($html->image('icono_facebook.png', array('alt' => __('Facebook', true))), 'http://www.facebook.com/home.php?#!/pages/Yo-ayudo-a-regalar-una-plaza/134635289915308?v=wall&ref=search', array('escape' => false)); ?></li>
