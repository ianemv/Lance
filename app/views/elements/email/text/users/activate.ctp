...
<?php echo sprintf(__('Para votar por tu plaza(s) favorita(s) necesitas confirmar tu Email, haciendo click en el siguiente link: %s'), $data['User']['activate_link']); ?>

<?php echo __('Automaticamente vas a volver a la página de votación. Puedes votar un máximo de 10 veces, una vez al día.', true);?>     
